...
{"visible" => true, "category" => "", "version_supported" => "2.2", "api"=>"AudioCapture", "file"=>"/rhoelements/AudioCapture/", "description"=>"", "html"=>"lic", "js"=>"lic", "ruby"=>"true", "rhoe"=>true, "rhodes"=>false, "msionly"=>false,"ios" => true,"android"=>true,"wm"=>true,"wince"=>true,"win32"=>true,"win7"=>true,"bb"=>false,"rhosim"=>false},
...
{"visible" => true, "category" => "", "version_supported" => "2.2", "api"=>"ECompass", "file"=>"/rhoelements/RawSensors/", "description"=>"", "html"=>"lic", "js"=>"lic", "ruby"=>"true", "rhoe"=>true, "rhodes"=>false, "msionly"=>false,"ios" => true,"android"=>true,"wm"=>false,"wince"=>false,"win32"=>false,"win7"=>false,"bb"=>false,"rhosim"=>false},
