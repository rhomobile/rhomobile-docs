...
{"visible" => true, "category" => "", "version_supported" => "2.0", "api"=>"RhoApplication", "file"=>"/rhodesapi/rhoapplication-api/", "description"=>"", "html"=>"false", "js"=>"none", "ruby"=>"true", "rhoe"=>true, "rhodes"=>true, "msionly"=>false,"ios" => true,"android"=>true,"wm"=>true,"wince"=>true,"win32"=>true,"win7"=>true,"bb"=>true,"rhosim"=>true},
