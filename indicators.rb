...
{"visible" => true, "category" => "", "version_supported" => "2.1", "api"=>"Raw Sensors", "file"=>"/rhoelements/RawSensors/", "description"=>"", "html"=>"lic", "js"=>"lic", "ruby"=>"lic", "rhoe"=>true, "rhodes"=>false, "msionly"=>true,"ios" => false,"android"=>true,"wm"=>false,"wince"=>false,"win32"=>false,"win7"=>false,"bb"=>false,"rhosim"=>false},
