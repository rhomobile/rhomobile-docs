...
{"visible" => true, "category" => "", "version_supported" => "2.0", "api"=>"SignatureCapture Inline", "file"=>"/rhodesapi/signaturecapture-api/", "description"=>"", "html"=>"false", "js"=>"true", "ruby"=>"lic", "rhoe"=>true, "rhodes"=>false, "msionly"=>false,"ios" => true,"android"=>true,"wm"=>true,"wince"=>true,"win32"=>true,"win7"=>true,"bb"=>true,"rhosim"=>true},
