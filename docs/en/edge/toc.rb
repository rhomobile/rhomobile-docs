...
section 'rhodescommonapi-reference', '4.0 API Reference','Mobile API Docs' do
  ...
  topic 'en/edge/api/Manager',      'NFC-Manager'
  topic 'en/edge/api/Message',      'NFC-Message'
  topic 'en/edge/api/Record',      'NFC-Record'
  topic 'en/edge/api/Tag',      'NFC-Tag'
...
section 'rhoconnect-push-reference', 'Push Sync','RhoConnect Guides' do
  ...
  # topic 'en/edge/rhoconnect/push-client-setup-bb',       'Setup for BlackBerry'
