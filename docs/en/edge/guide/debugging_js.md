...
You can **toggle the Console** while in other tabs **by using the Show Console button** at the bottom-left corner of other tabs.

![Embedded Console](http://rhodocs-images.s3.amazonaws.com/guide/debugging_with_rhosimulator/console-embedded.png)

#### Logging

The Console logs errors and warnings from the system and and log messages generated by your application code. These also can be filtered by type. 
