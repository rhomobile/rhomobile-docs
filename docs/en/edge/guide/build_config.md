...
<table class="table table-striped table-bordered table-condensed">
	...
	<tr>
		<td class="clsEvenRow">Android Manifest Templates</td>
		<td class="clsEvenRow">Currently it is possible to specify manifest erb template file at build.yml</code>.</td>
		<td class="clsEvenRow">x86 - Build for Intel Processors<br/>arm - Build for arm-based processors</td>
		<td class="clsEvenRow">android:<br/>&nbsp;&nbsp;abis: [x86]</td>
	</tr>
</table>
