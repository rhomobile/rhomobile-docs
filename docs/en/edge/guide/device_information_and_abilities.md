...
RhoMobile supports integrated and add-on magnetic stipe card readers on Motorola Solutions devices. The [CardReader API](../api/cardreader) `enumerate` method allows you to get a list of the available card readers.
