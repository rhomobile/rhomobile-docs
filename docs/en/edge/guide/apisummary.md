...
Below is a list of the new common APIs for RhoMobile Suite 5.3, which are recommended for all new projects. If you're moving a 2.x app to 5.x, please consult the [2.x migration guide](apiusage). 
