...
Possible Values: **Fully qualified path to file defining the regular expressions**<a href="#_caseSensitivity">&dagger;</a><br>
Platforms: **Android, iOS, WM/CE**<br>
...
Possible Values: **Fully qualified path to file defining the plugins<a href="#_caseSensitivity">&dagger;**<br>
Platforms: **Android, iOS, WM/CE**<br>
...
Possible Values: **Fully qualified path to folder containing web application.<a href="#_caseSensitivity">&dagger;</a>**<br>
Platforms: **Android, iOS, WM/CE**<br>
...
###General\\StartPage
Defines the start page of the RhoElements application, the first page to be displayed when RhoElements is launched.  This should be a local file to avoid connectivity issues on start up.</td>
      <td class="clsEvenRow">Fully qualified path to start page.<a href="#_caseSensitivity">&dagger;</a><br>
...
Path to an existing directory to store Web Storage databases</td>
      <td>Fully qualified local path.<a href="#_caseSensitivity">&dagger;<br>
...
Possible Values: **Fully qualified local path.<a href="#_caseSensitivity">&dagger;**<br>
...
Possible Values: **ully qualified local path.<a href="#_caseSensitivity">&dagger;**<br>
Platforms: **Android, iOS, WM/CE**<br>
