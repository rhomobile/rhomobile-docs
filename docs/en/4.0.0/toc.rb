section 'getting-started',                'Introduction', 'Mobile Guides' do
  topic 'en/4.0.0/guide/welcome',         'Welcome to RhoMobile Suite'
  topic 'en/4.0.0/guide/rhoArchitecture', 'Supported Platforms'
  topic 'en/4.0.0/guide/devskills',       'Developer Skills'
  topic 'en/4.0.0/guide/devenvironment',  'Developer Environments'
  topic 'en/4.0.0/guide/appdesign',       'App Architecture'
  topic 'en/4.0.0/guide/uichoices',       'UI Architecture'
  topic 'en/4.0.0/guide/kitchensink',     'KitchenSink Application'
  topic 'en/4.0.0/guide/apiusage',        '2.2 Migration Guide'
  topic 'en/4.0.0/guide/api_js',          'RhoMobile JavaScript Usage'
  topic 'en/4.0.0/guide/api_ruby',        'RhoMobile Ruby Usage'
...
section 'rhomob-apps',                        'Developing Apps','Mobile Guides' do
  topic 'en/4.0.0/guide/creating_a_project',  'Starting a New Project'
  topic 'en/4.0.0/guide/runtime_config',      'Run-time Configuration'
  topic 'en/4.0.0/guide/build_config',        'Build-time Configuration'
  topic 'en/4.0.0/guide/build_ios',           'Build for iOS'
  topic 'en/4.0.0/guide/build_android',       'Build for Android'
  topic 'en/4.0.0/guide/build_wm',            'Build for Windows Mobile'
  topic 'en/4.0.0/guide/build_wp8',           'Build for Windows Phone 8'
  topic 'en/4.0.0/guide/build_win',           'Build for Windows'
  topic 'en/4.0.0/guide/using_emulators',     'Using Native Emulators'
  topic 'en/4.0.0/guide/app_icon_splash',     'Application Icon & Splash Screen'
  topic 'en/4.0.0/guide/css-framework',       'CSS Frameworks'
  topic 'en/4.0.0/guide/webapps',             'RhoMobile for Web Apps'
  topic 'en/4.0.0/guide/rhoelements-runtime', 'RhoElements Shared Runtime'
  topic 'en/4.0.0/guide/webcontainer',        'Custom Web App Container'
  topic 'en/4.0.0/guide/app_upgrade',         'Upgrading Your App'
end

section 'rhomob-data',                      'Data Handling','Mobile Guides' do
  topic 'en/4.0.0/guide/local_database',    'Local Database and Rhom'
  topic 'en/4.0.0/guide/rhom_ruby',         'Using Rhom with Ruby'
...
section 'rhomob-dev',                                       'Device Capabilities','Mobile Guides' do
  topic 'en/4.0.0/guide/barcode',                           'Barcode'
  topic 'en/4.0.0/guide/bluetooth',                         'Bluetooth'
  topic 'en/4.0.0/guide/camera',                            'Camera'
  topic 'en/4.0.0/guide/pim',                               'Contacts & Calendar'
  topic 'en/4.0.0/guide/controlling_webview_behavior',      'Controlling Webview Behavior'
  topic 'en/4.0.0/guide/device_hardware_key_handling',      'Device Notifications & Keylight'
  topic 'en/4.0.0/guide/device_information_and_abilities',  'Detecting Device Abilities'
  topic 'en/4.0.0/guide/hardware_accleration',              'Hardware Acceleration'
  topic 'en/4.0.0/guide/html5',                             'Html5 Tags'
  topic 'en/4.0.0/guide/handling_local_files',              'File System'
  topic 'en/4.0.0/guide/geolocation',                       'Geolocation'
  topic 'en/4.0.0/guide/localization',                      'Localization'
  topic 'en/4.0.0/guide/maps',                              'Mapping'
  topic 'en/4.0.0/guide/media',                             'Media & Ringtones'
  topic 'en/4.0.0/guide/native_ui_elements',                'Native UI Components'
  topic 'en/4.0.0/guide/interfacing_with_the_network',      'Network Interfacing'
  topic 'en/2.2.0/rhodes/nfc',                              'NFC'
  topic 'en/4.0.0/guide/screen_orientation',                'Orientation and Responsive Design'
  topic 'en/4.0.0/guide/printing',                          'Printing'
  topic 'en/4.0.0/guide/push_notifications',                'Push Notifications'
  topic 'en/4.0.0/guide/device_sensors',                    'Sensors'
  topic 'en/4.0.0/guide/signature',                         'Signature'
  topic 'en/4.0.0/guide/urlschemes',                        'Url Schemes'
end

section 'rhomob-test',                                'Testing & Debugging','Mobile Guides' do
  topic 'en/4.0.0/guide/debugging_with_rhosimulator', 'Debugging with RhoSimulator'
  topic 'en/4.0.0/guide/remote-debug',                'Debugging JS On Devices'
  topic 'en/4.0.0/guide/logging',                     'Logging'
  topic 'en/4.0.0/guide/testing',                     'Testing'
  topic 'en/4.0.0/guide/profiling',                   'Performance Profiling'
end

section 'rhomob-ext',                       'Extending','Mobile Guides' do
  topic 'en/4.0.0/guide/native_extensions', 'Extending the Rhodes Framework'
  topic 'en/4.0.0/guide/ruby_extensions',   'RhoMobile Ruby Environment'
  topic 'en/4.0.0/guide/view_extensions',   'View Extensions'
end
...
section 'rhoconnect-push-reference',                      'Push Sync','RhoConnect Guides' do
  ...
  topic 'en/4.0.0/rhoconnect/push-backend-setup',         'Setup on Back-end'
