...
The MapView class provides an embeddable map interface, similar to the one provided by the Maps application. Click the links below for detailed information about the [MapView API methods](../../2.2.0/rhodesapi/mapview-api).

 * [create](../../2.2.0/rhodesapi/mapview-api#create) - Create a map on your device.
 * [set_file_caching_enable](../../2.2.0/rhodesapi/mapview-api#setfilecachingenable) - Enable file caching for map tiles. The file cache can be used for offline map browsing.
 * [preload_map_tiles](../../2.2.0/rhodesapi/mapview-api#preloadmaptiles) - Preload a map tiles for a region defined by a zoom level range.
