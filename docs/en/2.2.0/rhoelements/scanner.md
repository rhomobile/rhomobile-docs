...
If you are using an RS507/RS6000/RS4000 scanner you can register for connectionListenerEvent to receive the status of connected or disconnected state of the particular scanner through this event. **Note**: _This feature is supported on Android Lollipop platform only. It is not supported on TC70 GA1 device._
...
The following example demonstrates to how to set the connectionListenerEvent from html page. **Note**: _This feature is supported from Android Lollipop platform only. It is not supported on TC70 GA1 device._:
