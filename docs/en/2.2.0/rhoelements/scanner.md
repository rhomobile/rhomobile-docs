...
If you are using an RS507/RS6000/RS4000 scanner you can register for connectionListenerEvent to receive the status of connected or disconnected state of the particular scanner through this event. Note: This feature is supported from Android Kitkat version and above. It is not supported on TC70 GA1 device.
