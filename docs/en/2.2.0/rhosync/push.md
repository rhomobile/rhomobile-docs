...
The [RhoSync Web Console](web-console) includes a utility for testing push to make sure everything is wired up correctly.  
...
You can trigger a push remotely using the [RhoSync API Ping method](rest-api).  This is useful if you want to fully control the push process from a remote server (instead of your source adapter).
