...
This contains your RhoSync license key text.  By default, a RhoSync application comes with a 10 device license.  Please see the [licensing page](licensing) for more details.
