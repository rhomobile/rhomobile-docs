...
===
Rhodes provides another utility for connecting to backend services besides the [`SyncEngine`](synchronization) called `AsyncHttp`.  Your application can use the `AsyncHttp` library to interact with web services, pull remote images, etc.
