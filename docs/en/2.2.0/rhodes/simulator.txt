...
If you have the [Rhodes gem](install#installing-rhodes-from-the-command-line), then RhoSimulator is installed already.
...
Alternatively you may build your own customized version of RhoSimulator as described [below](#build-rhosimulator).
