...
This example will show how each of the methods and properties of the ScreenOrientation API work in your EB app. Note: This example assumes that the ebapi-modules.js file is in the same folder as html file invoking it.
<pre><code>:::javascript
&lt;head&gt;
    &lt;script type="text/javascript" charset="utf-8" src="ebapi-modules.js"&gt;&lt;/script&gt;
