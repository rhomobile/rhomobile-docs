...
### addMessage(<span class="text-info">STRING</span> messageID)Add new Smart Poster message to the message.
...
### addRecord(<span class="text-info">STRING</span> recordID)Add new Record to Message.
...
####Returns
Synchronous Return:<ul><li>Rho.NFC.Message : Created Message object.</li></ul>
...
### getContent()Returns Message as byte array.
...
####Returns
Synchronous Return:<ul><li>STRING : Message to get.</li></ul>
...
### getMessageById(<span class="text-info">STRING</span> id)This function returns Message object.
...
####Returns
Synchronous Return:<ul><li>SELF_INSTANCE : "self" instance of the Message object.</li></ul>
...
### getMessages()Return array of Smart Poster Message objects.
...
####Returns
Synchronous Return:<ul><li>ARRAY : Array of Rho.NFC.Message objects.<ul><li><i>Object</i> : <span class='text-info'>Rho.NFC.Message</span><p> </p></li></ul></li></ul>
...
### getRecords()Return array of Record objects.
...
####Returns
Synchronous Return:<ul><li>ARRAY : Array of Rho.NFC.Record objects.<ul><li><i>Object</i> : <span class='text-info'>Rho.NFC.Record</span><p> </p></li></ul></li></ul>
