...
Array of Card reader objects.<ul><li>cardreaderArray : <span class='text-info'>SELF_INSTANCE: Rho.CardReader</span><p> </p></li></ul></li></ul>
...
### setDefault(<span class="text-info">SELF_INSTANCE: Rho.CardReader</span> defaultInstance)
This method allows you to set the attributes of the default object instance by passing in an object of the same class.

####Parameters
<ul><li>defaultInstance : <span class='text-info'>SELF_INSTANCE: Rho.CardReader</span><p>
