...
### calcSumm(<span class="text-info">INTEGER</span> a, <span class="text-info">INTEGER</span> b)Return sum of two params: a+b.
...
####Returns
Synchronous Return:<ul><li>ARRAY : Array of PrintingEpson objects.<ul><li><i>Object</i> : <span class='text-info'>SELF_INSTANCE: Rho.PrintingEpson</span><p> </p></li></ul></li></ul>
...
### getPlatformName()Return string with platform.
...
### joinStrings(<span class="text-info">STRING</span> a, <span class="text-info">STRING</span> b)Return join of two strings: a+b.
...
### setDefault(<span class="text-info">SELF_INSTANCE: Rho.PrintingEpson</span> defaultInstance)This method allows you to set the attributes of the default object instance by passing in an object of the same class.

####Parameters
<ul><li>defaultInstance : <span class='text-info'>SELF_INSTANCE: Rho.PrintingEpson</span><p>An instance object that is of the same class. </p></li><li>callback : <span class='text-info'>CallBackHandler</span></li></ul>
