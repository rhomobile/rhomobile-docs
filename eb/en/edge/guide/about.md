...
* **[&lt;KeepAlive&gt;](../guide/configreference?KeepAlive)** provides the option of maintaining a connection from client to server between HTTP requests. **For Windows Mobile/CE with Webkit engine only**. 

* **[&lt;LogTrace&gt;](../guide/configreference?LogTrace)** provides logging of the Trace messages generated by Enterprise Browser. **For Android and Windows Mobile/CE**.

* **[&lt;usedwforscanning&gt;](../guide/configreference?usedwforscanning)** controls whether to 'use DataWedge (DW) for scanning' or to go through Enterprise Browser APIs. Refer to the [DataWedge Usage Guide](../guide/datawedge) for details. **For Android only**.
